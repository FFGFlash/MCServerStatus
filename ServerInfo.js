...
function useDefaultStatusBox(StatusBoxID) {
  $(function() {
    $(StatusBoxID).html(
    "<div id='status-box'><link rel='stylesheet' href='https://cdn.rawgit.com/FFGFlash/MCServerStatus/bf5d0c0c/stylesheet.css'/><div id='uStatus'><h3><span id='status-icon'></span> <span id='ip'></span></h3></div><div id='lStatus'>Status: <span id='status'></span><br>Players: <span id='players'></span></div></div>"
    );
  });
}
