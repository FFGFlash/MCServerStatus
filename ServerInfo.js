  ...
  $(document).ready(function() {
    $.ajax({
      ...
      success: function(data) {
        ...
        $('#status-icon').html(json.online ? '<img width="50" height="50" src="https://cdn.rawgit.com/FFGFlash/MCServerStatus/01609718/online.png"/>':'<img width="50" height="50" src="https://cdn.rawgit.com/FFGFlash/MCServerStatus/5b5e4055/icon-19.png"/>');
